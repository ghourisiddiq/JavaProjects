...
import com.deloitte.util.HibernateUtil;

public class Main {
  
  public static void main(String[] args) {
    HibernateUtil.setup("create table Supplier ( id int, name VARCHAR2);");
    HibernateUtil.setup("create table Product ( id int, name VARCHAR2, description VARCHAR2, price double,supplierId int);");
